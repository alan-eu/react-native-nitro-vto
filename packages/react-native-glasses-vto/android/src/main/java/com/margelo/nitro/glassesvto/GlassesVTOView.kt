...
/**
 * GlassesVTOView - A FrameLayout containing the AR glasses try-on view.
 *
 * This view handles:
 ...
 */
class GlassesVTOView(context: Context) : FrameLayout(context) {

    companion object {
        private const val TAG = "GlassesVTOView"
    }
    ...
    private fun initialize() {
        ...
        isInitialized = true
        Log.d(TAG, "GlassesVTOView initialized")
    }
