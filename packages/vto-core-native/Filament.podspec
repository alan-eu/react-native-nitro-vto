# Forked from https://github.com/google/filament/blob/v1.69.3/ios/CocoaPods/Filament.podspec
# Drops the EXCLUDED_ARCHS[sdk=iphonesimulator*] = arm64 lines so that arm64
# simulator builds work on Apple silicon. Filament 1.69.3 ships an
# arm64-iphonesimulator slice in its xcframework; the upstream exclusion is a
# legacy guard from when it didn't.
#
# Consumers don't reference this file directly. The `withFilamentArchFix`
# Expo config plugin injects a `pod 'Filament', '1.69.3', :podspec => URL`
# line into the consumer's Podfile, and CocoaPods fetches this file at the
# matching git tag.
