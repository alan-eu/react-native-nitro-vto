...
namespace margelo::nitro::nitrovto {
  ...
  public:
    ...
    bool equals(const std::shared_ptr<HybridObject>& other) override {
      if (auto otherCast = std::dynamic_pointer_cast<HybridNitroVtoViewSpecSwift>(other)) {
  ...
  public:
    ...
    inline std::optional<std::function<void()>> getOnFaceTracked() noexcept override {
      auto __result = _swiftPart.getOnFaceTracked();
      return __result;
    }
