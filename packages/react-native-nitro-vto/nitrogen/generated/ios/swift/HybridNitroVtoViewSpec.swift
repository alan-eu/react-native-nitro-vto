...
public protocol HybridNitroVtoViewSpec_protocol: HybridObject, HybridView {
  ...
  var onArUnavailable: ((_ reason: String) -> Void)? { get set }
...
open class HybridNitroVtoViewSpec_base {
  ...
  public func getCxxWrapper() -> HybridNitroVtoViewSpec_cxx {
  #if DEBUG
    guard self is any HybridNitroVtoViewSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridNitroVtoViewSpec_cxx(self as! any HybridNitroVtoViewSpec)
