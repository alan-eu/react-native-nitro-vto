...
open class HybridNitroVtoViewSpec_cxx {
  ...
  public final var modelWidthMeters: Double {
    @inline(__always)
    get {
      return self.__implementation.modelWidthMeters
    }
    @inline(__always)
    set {
      self.__implementation.modelWidthMeters = newValue
    }
  }
  ...
  // Methods
  @inline(__always)
  public final func switchModel(modelUrl: std.string, widthMeters: Double) -> bridge.Result_void_ {
    do {
      try self.__implementation.switchModel(modelUrl: String(modelUrl), widthMeters: widthMeters)
