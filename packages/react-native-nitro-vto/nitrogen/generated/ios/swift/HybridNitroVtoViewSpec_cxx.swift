...
open class HybridNitroVtoViewSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridNitroVtoViewSpec_cxx) -> Bool {
  ...
  public final var forwardOffset: bridge.std__optional_double_ {
    ...
    @inline(__always)
    set {
      self.__implementation.forwardOffset = { () -> Double? in
  ...
  public final var mode: bridge.std__optional_std__string_ {
    @inline(__always)
    get {
    ...
    @inline(__always)
    set {
      self.__implementation.mode = { () -> String? in
  ...
  public final var previewBackgroundColor: bridge.std__optional_std__string_ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_std__string_ in
        if let __unwrappedValue = self.__implementation.previewBackgroundColor {
          return bridge.create_std__optional_std__string_(std.string(__unwrappedValue))
        } else {
          return .init()
        }
    ...
    @inline(__always)
    set {
      self.__implementation.previewBackgroundColor = { () -> String? in
        if bridge.has_value_std__optional_std__string_(newValue) {
          let __unwrapped = bridge.get_std__optional_std__string_(newValue)
          return String(__unwrapped)
        } else {
