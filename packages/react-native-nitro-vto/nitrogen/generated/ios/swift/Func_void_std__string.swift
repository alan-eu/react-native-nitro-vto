...
/**
 * Wraps a Swift `(_ modelUrl: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.nitrovto.bridge.swift

  private let closure: (_ modelUrl: String) -> Void

  public init(_ closure: @escaping (_ modelUrl: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(modelUrl: std.string) -> Void {
    self.closure(String(modelUrl))
  }
