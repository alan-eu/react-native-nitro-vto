...
/**
 * Represents the JavaScript callback `(modelUrl: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(modelUrl: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @FastNative
  private external fun invoke_cxx(modelUrl: String): Unit
}
