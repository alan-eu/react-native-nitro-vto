...
namespace margelo::nitro::nitrovto {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrovto/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrovto/Func_void_cxx;";
