...
namespace margelo::nitro::nitrovto {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrovto/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrovto/Func_void_cxx;";
